...
//    static final int PULL_LOAD_MORE = 0;
    ...
    String value;
    boolean flag=true;
    public RankRecyclerViewAdapter(Context context,List<Phone> data,int status,String value,boolean flag){
    ...
    RankRecyclerViewAdapter.FootViewHolder f=null;
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.rank_item, parent,
                    false);
            return new RankRecyclerViewAdapter.ItemViewHolder(view);
        } else if (viewType == TYPE_FOOTER) {
            View view = View.inflate(mContext, R.layout.item_foot, null);
            RankRecyclerViewAdapter.FootViewHolder footViewHolder = new RankRecyclerViewAdapter.FootViewHolder(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof RankRecyclerViewAdapter.ItemViewHolder){
            RankRecyclerViewAdapter.ItemViewHolder newHolder = (RankRecyclerViewAdapter.ItemViewHolder) holder;
            ...
            if(flag==true){
                ...
                if(value.equals("Total")){
                    newHolder.mark_text.setText(df.format((data.get(position).getSum_score())/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }else if(value.equals("Common")){
                    newHolder.mark_text.setText(df.format((data.get(position).getSum_score()-data.get(position).getGpu_num())/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }else if(value.equals("Game")){
                    newHolder.mark_text.setText(df.format((data.get(position).getGpu_num()+data.get(position).getCpu_num())/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }else if(value.equals("Camera")){
                    newHolder.mark_text.setText(df.format((data.get(position).getFront_cam_num()+data.get(position).getBack_cam_num())/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }else if(value.equals("XuHang")){
                    newHolder.mark_text.setText(df.format((data.get(position).getConsume_power_num()+data.get(position).getCharge_num())/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }else{
                    newHolder.mark_text.setText(df.format(data.get(position).getSum_score()/(data.get(position).getPrice1()-data.get(position).getDifferent_price()))+"分");
                }
            }else{
                ...
                if(value.equals("Total")){
                    newHolder.mark_text.setText(df.format(data.get(position).getSum_score())+"分");
                }else if(value.equals("Common")){
                    newHolder.mark_text.setText(df.format(data.get(position).getSum_score()-data.get(position).getGpu_num())+"分");
                }else if(value.equals("Game")){
                    newHolder.mark_text.setText(df.format(data.get(position).getGpu_num()+data.get(position).getCpu_num())+"分");
                }else if(value.equals("Camera")){
                    newHolder.mark_text.setText(df.format(data.get(position).getFront_cam_num()+data.get(position).getBack_cam_num())+"分");
                }else if(value.equals("XuHang")){
                    newHolder.mark_text.setText(df.format(data.get(position).getConsume_power_num()+data.get(position).getCharge_num())+"分");
                }else{
                    newHolder.mark_text.setText(df.format(data.get(position).getSum_score())+"分");
                }
            }
            ...
            RankRecyclerViewAdapter.FootViewHolder footViewHolder = (RankRecyclerViewAdapter.FootViewHolder) holder;
